...
public partial class app_ucItemLookup : CAppUserControl
{
    ...
    private event EventHandler<CAppUserControlArgs> _OptionSelect;
    /// <summary>
    /// event
    /// fires when an option is selected
    /// </summary>
    public event EventHandler<CAppUserControlArgs> OptionSelect
    {
        add { _OptionSelect += new EventHandler<CAppUserControlArgs>(value); }
        remove { _OptionSelect -= value; }
    }
