            ...
            <asp:TemplateField AccessibleHeaderText="Values"
                ...
                <ItemTemplate>
                    ...
                    <asp:Panel ID="pnlViewValue" runat="server"
                        ...
                        <!--collection values-->  
                        <asp:Button ID="btnShowHiddenCollValues" runat="server"
                            OnClientClick="javascript:if(this.value == '+'){this.value = '-';}else{this.value = '+';}"
                            Text="+" Width="30" />
                        <asp:Label ID="lblCollValues" runat="server" Width="200">
                            <asp:Panel ID="pnlHiddenCollValues" runat="server">
                                <asp:Literal ID="litHiddenCollValues" runat="server" />
                            </asp:Panel>
                            <asp:CollapsiblePanelExtender ID="cpeHiddenCollValues" runat="server"
                                AutoCollapse="false"
                                AutoExpand="false"
                                CollapseControlID="btnShowHiddenCollValues"
                                Collapsed="true" 
                                ExpandControlID="btnShowHiddenCollValues"
                                ExpandDirection="Vertical"
                                SuppressPostBack="true"
                                TargetControlID="pnlHiddenCollValues" 
                                 />
                        </asp:Label>
                        <!--end collection values-->    
                    </asp:Panel>
                </ItemTemplate>
            </asp:TemplateField>
